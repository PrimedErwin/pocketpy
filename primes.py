...
class Sieve:
    ...
    def calc(self):
        ...
        self.loop_x()
        #     _end_ns = time.time()
        #     result_ns = _end_ns-_start_ns
        # print(f'loopx spend = {_start_ns}-{_end_ns}={result_ns} s')
        retval = 0
        # result_ns = 0
        # while result_ns == 0:
        #     start_ns = time.time_ns()
        #     retval = self.omit_squares()
        #     end_ns = time.time_ns()
        #     result_ns = end_ns-start_ns
        # print(f'omit spend = {result_ns} ns')
...
def find(upper_bound, prefix):
    ...
    while result_ns == 0:
        ...
        end_ns = time.time()
        result_ns = end_ns-start_ns
    print(f'Sieve spend = {result_ns} s')
    ...
    while result_ns == 0:
        ...
        end_ns = time.time_ns()
        result_ns = end_ns-start_ns
    print(f'trie spend = {result_ns} ns')
